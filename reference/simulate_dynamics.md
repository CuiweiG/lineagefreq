...
#> Date range: 2026-04-05 to 2026-07-12
#> Lineages: "JN.1, KP.3, ref"
#> 
#> # A tibble: 45 × 7
#>    .date      .lineage .count true_freq .total .freq .reliable
#>  * <date>     <chr>     <int>     <dbl>  <int> <dbl> <lgl>    
#>  1 2026-04-05 JN.1        156     0.333    500 0.312 TRUE     
#>  2 2026-04-05 KP.3        184     0.333    500 0.368 TRUE     
#>  3 2026-04-05 ref         160     0.333    500 0.32  TRUE     
#>  4 2026-04-12 JN.1        204     0.406    500 0.408 TRUE     
#>  5 2026-04-12 KP.3        143     0.281    500 0.286 TRUE     
#>  6 2026-04-12 ref         153     0.312    500 0.306 TRUE     
#>  7 2026-04-19 JN.1        240     0.483    500 0.48  TRUE     
#>  8 2026-04-19 KP.3        120     0.231    500 0.24  TRUE     
#>  9 2026-04-19 ref         140     0.286    500 0.28  TRUE     
#> 10 2026-04-26 JN.1        307     0.560    500 0.614 TRUE     
#> # ℹ 35 more rows
```
